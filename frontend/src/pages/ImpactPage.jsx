        ...
        <div className="page-container">
            <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    ...
                    <p style={{ color: 'var(--text-secondary)' }}>Track your contribution to sustainability and circular economy</p>
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
                ...
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">Sustainability Score Breakdown</h3>
                    </div>
                    {pieData.length === 0 ? (
            ...
            {metrics.rawMaterialSaved > 0 && (
                <div className="card" style={{ marginTop: '2rem' }}>
                    <div className="card-header">
                        <h3 className="card-title">Raw Material Savings</h3>
                    </div>
